...
class Util {
  ...
  static AlltrackEvent buildSimpleEvent() {
    return new AlltrackEvent(EVENT_TOKEN_SIMPLE);
  }

  static AlltrackEvent buildRevenueEvent() {
  ...
  static AlltrackEvent buildCallbackEvent() {
  ...
  static AlltrackEvent buildPartnerEvent() {
